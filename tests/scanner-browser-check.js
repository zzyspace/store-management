...
export async function checkScanner({ page, f, checkSize }) {
  ...
  await openIssueScanner(page); await scanAndConfirm(page, "FUZZY-ZY-9003"); await page.locator("#scanEnd").click();
  ...
  await openIssueScanner(page); await scanAndConfirm(page, "FUZZY-ZY-9004"); await page.locator("#scanEnd").click();
  await page.locator("#issueSubmit").click();
